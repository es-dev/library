...
namespace Library.Template.Controls
{
    public partial class TemplateEditEmail : UserControl, IEditControl
    {
        ...
        private void TemplateEditEmail_Load(object sender, EventArgs e)
        {
            try
            {
                SetEditing(editing);
        ...
        private bool IsVerified(bool required)
        {
            try
            {
                if (editValue != null)
                {
                    ...
                    bool isEmail = (UtilityValidation.IsEmail(value));
                    bool verified = (required && compiled && isEmail) || (!required && (!compiled || (compiled && isEmail)));
                    return verified;
                }
            }
            catch (Exception ex)
