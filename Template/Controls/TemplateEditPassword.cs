...
{
    public partial class TemplateEditPassword : UserControl, IEditControl, IEditValue<string>
    {
        const string mask = "------";
        ...
        public void InitJQ()
        {
            try
            {
                ...
                JQScript = jquery.GetEditPassword(editValue,mask);
            }
            catch (Exception ex)
            {
                UtilityError.Write(ex);
        ...
        private void TemplateEditPassword_Load(object sender, EventArgs e)
        {
            try
            {
                SetEditing(editing);
        ...
        private void SetPasssword(bool password)
        {
            try
            {
                editValue.UseSystemPasswordChar = password;
            }
            catch (Exception ex)
            {
                UtilityError.Write(ex);
